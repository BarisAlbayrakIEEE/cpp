...
namespace GeometryNamespace {
		...
		: VectorBase(DIMENSIONS::D3)
	{
		...
		CoordSystem coordsystem {theVector.getReferenceCoordSystem()};
		c_referenceCoordSystem = std::shared_ptr<CoordSystem>(&coordsystem);
	...
	Vector3D Vector3D::getUnitVector() const {
		return Vector3D(*c_referenceCoordSystem, getUnitVectorComponents());
	}
